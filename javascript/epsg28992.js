(function () {
  ...
  var module = angular.module("ol.proj.EPSG28992", []).config(function () {
    ol.proj.EPSG28992 = {};
    ...
    ol.proj
      .get("EPSG:28992")
      .setWorldExtent([
        -1.65729160235431, 48.0405018704265, 11.2902578747914, 55.9136415748388
      ]);

    ol.proj
      .get("urn:ogc:def:crs:EPSG::28992")
      .setExtent(ol.proj.get("EPSG:28992").getExtent());
    ol.proj
      .get("urn:ogc:def:crs:EPSG::28992")
      .setWorldExtent(ol.proj.get("EPSG:28992").getWorldExtent());

    ol.proj
      .get("http://www.opengis.net/gml/srs/epsg.xml#28992")
      .setExtent(ol.proj.get("EPSG:28992").getExtent());
    ol.proj
      .get("http://www.opengis.net/gml/srs/epsg.xml#28992")
      .setWorldExtent(ol.proj.get("EPSG:28992").getWorldExtent());
    ...
    ol.proj.EPSG28992.CODES.forEach(function (code) {
      ol.proj.EPSG28992.PROJECTIONS[code] = new ol.proj.EPSG28992_(code);
    });
    ...
    ol.proj.addCoordinateTransforms(
      "EPSG:4326",
      "EPSG:28992",
      proj4("EPSG:4326", "EPSG:28992").forward,
      proj4("EPSG:4326", "EPSG:28992").inverse
    );
  });
})();
