...
(function () {
  goog.provide("gn_search_dutch_directive");

  var module = angular.module("gn_search_dutch_directive", []);
  ...
  module.directive("gnInfoList", [
    ...
    function (gnMdView) {
      return {
        restrict: "A",
        replace: true,
        templateUrl: "../../catalog/views/dutch/directives/" + "partials/infolist.html",
  ...
  module.directive("gnMdActionsMenu", [
    ...
    "gnGlobalSettings",
    "gnMdFormatter",
    function (gnMetadataActions, $http, gnConfig, gnConfigService, gnGlobalSettings, gnMdFormatter) {
      return {
        restrict: "A",
        replace: true,
        templateUrl:
